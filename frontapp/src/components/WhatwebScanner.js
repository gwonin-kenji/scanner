...
function WhatwebScanner() {
  ...
  const handleScan = async () => {
    ...
    try {
      const response = await axios.get(`${API_BASE_URL}/whatweb?url=${url}`);
  ...
  return (
    <div className="max-w-xl mx-auto my-6 p-6 border rounded-2xl shadow-lg bg-white">
      <h2 className="text-2xl font-semibold mb-4 text-gray-800">WhatWeb スキャナ</h2>
